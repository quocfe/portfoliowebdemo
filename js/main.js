...
portfolioCloseBtns .forEach((portfolioCloseBtn) => {
    portfolioCloseBtn.addEventListener("click", () => {
        portfolioModels.forEach((portfolioView) => {
...
var swiper = new Swiper(".client-swiper", {
    slidesPerView: 1, // số lượng trình bày trên mỗi lần xem //
    spaceBetween: 30,
    loop: true,
    pagination: {
...
themeBtn.addEventListener("click", () => {
    ...
    localStorage.setItem("saved-theme", getCurrenyTheme());
    localStorage.setItem("saved-icon", getCurrenyIcon());
});

const getCurrenyTheme = () => document.body.classList.contains("dark-theme") ? "dark" : "light";
const getCurrenyIcon = () => themeBtn.classList.contains("dark-theme") ? "sun" : "moon";
...
//Navigation menu items active on page scroll (chưa hiểu đc)
window.addEventListener("scroll", () => {
